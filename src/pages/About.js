    ...
    <div>
      ...
      <div className="container about-content">
        <div className="about-intro card">
          ...
          <h2>Our Mission</h2>
          <p>AcadHR was built with one goal in mind: to make teacher recruitment simpler, faster, and more trustworthy for everyone involved. We believe great teachers deserve great opportunities — and great schools deserve to find them easily.</p>
        </div>
        ...
        <div className="about-cta card">
          <h2>Join AcadHR Today</h2>
          <p>Whether you're a teacher looking for your next opportunity or a school searching for talented educators, AcadHR makes the connection simple.</p>
